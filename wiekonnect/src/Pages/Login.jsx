    ...
    return (
        ...
        <div className="flex flex-col items-center w-[95%] max-w-md bg-gray-900 px-8 py-10 ">
          <div className="flex justify-center items-center gap-5">
            <FaGoogle className=" bg-gray-900 cursor-pointer text-white border rounded-lg border-[#4a006f] text-5xl w-32 p-2"/>
            <FaApple className="text-white cursor-pointer border border-[#4a006f] rounded-lg bg-gray-900 text-5xl w-32 p-2"/>
          </div>  
            <form 
            className="flex flex-col w-full mt-10 gap-2">
                <div className="flex flex-col gap-6">
                   <div className="">
                        ...
                        name="email"
                        placeholder="Email"
                        className="w-full border-b-2 text-gray-200 border-gray-200 focus:border-2 focus:border-white focus:outline-none px-3 py-2"
                        />
                    </div>    
                    <div>
                        <input 
